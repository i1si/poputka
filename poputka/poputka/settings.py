...
WSGI_APPLICATION = 'poputka.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('PP_POSTGRES_DB'),
        'USER': os.environ.get('PP_POSTGRES_USER'),
        'PASSWORD': os.environ.get('PP_POSTGRES_PASSWORD')
        # 'PORT': getenv('PG_PORT'),
    }
}
